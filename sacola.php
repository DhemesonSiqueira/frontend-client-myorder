    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="bg-light comments-box p-3 mt-3">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <span class="">    <div class="btn-group">
        ...
        <div class="modal-footer">
          <b><p class="">Total: R$30,00</p></b> <br>
...
<a class="bolsa-modal" data-toggle="modal" data-target="#exampleModalCenter" href="https://wa.me/55(aqui seu numero com ddd | tudo junto)?text=Adorei%20seu%20artigo" 
style="position:fixed;
width:60px;
height:60px;bottom:60px;
right:15px;background-color:#ffc700;color:#FFF;border-radius:50px;text-align:center;font-size:30px;box-shadow: 1px 1px 2px #888;
